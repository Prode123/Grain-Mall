...
//	@ListValue(vals = {0,1},message = "显示状态[0-不显示；1-显示]必须是0或1",groups = AddGroup.class)
	...
	@NotNull(message = "显示状态[0-不显示；1-显示]不能为空",groups = {AddGroup.class,UpdateStatusGroup.class})
